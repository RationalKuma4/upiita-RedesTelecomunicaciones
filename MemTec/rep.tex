...
%arquitectónico es de tipo moderno. 
...
%\newpage
%Jerarquía SDH para un modelo Europeo.
%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=1\textwidth]{imagenes/sdhj.png}
...
%Ahora se muestra una imagen con la descripción de las entradas disponibles. Vale la pena 
%mencionar que cuenta con dos entradas SFPI.
\begin{figure}[ht]
    \centering
